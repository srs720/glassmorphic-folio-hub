...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Shoibur Rahman (Siam) — full-stack web developer from Bangladesh. Bilingual personal portfolio, research posts and digital diary." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Shoibur Rahman | Full-Stack Web Developer" },
      { name: "twitter:description", content: "Shoibur Rahman (Siam) — full-stack web developer from Bangladesh. Bilingual personal portfolio, research posts and digital diary." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6242d8e4-7cd7-4023-8460-346c10e29a6a/id-preview-2b066b75--c9f93f8e-fd6c-40f8-8eac-053ccd0f69ff.lovable.app-1784684195448.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6242d8e4-7cd7-4023-8460-346c10e29a6a/id-preview-2b066b75--c9f93f8e-fd6c-40f8-8eac-053ccd0f69ff.lovable.app-1784684195448.png" },
    ],
    links: [
