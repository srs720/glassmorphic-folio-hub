...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Bilingual personal digital diary — journey, people, memories, food and thoughts by Shoibur Rahman." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Shoibur Rahman - Student & Web Developer" },
      { name: "twitter:description", content: "Bilingual personal digital diary of Shoibur Rahman." },
    ],
    links: [
