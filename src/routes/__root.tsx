...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A personal portfolio showcasing projects, work, and contact." },
      { property: "og:title", content: "Portfolio — Personal Site" },
      { property: "og:description", content: "A personal portfolio showcasing projects, work, and contact." },
